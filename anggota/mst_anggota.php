...
<?php
		...
		$query=mysqli_query($connect, "SELECT * FROM t_jenis_simpan WHERE nama_simpanan='pokok'");
...
<div class="row">
                <div class="col-lg-12">
                    ...
                    <?php
                        $am=mysqli_query($connect, "SELECT *from t_anggota where status='aktif'");
                        $jum=mysqli_num_rows($am);
                    echo'<kbd style="background-color:#d9534f;">'.$jum.'</kbd>';?>
                    <span style="float:right;">
                    <input type="text" id="cari" style="width:230px;height:30px;font-size:15px;" placeholder=" cari disini...">
...
<div class="row">
                <div class="col-lg-12">
                    ...
                    <?php
                        $am=mysqli_query($connect, "SELECT *from t_anggota where status='keluar'");
                        $jum=mysqli_num_rows($am);
                    echo'<kbd style="background-color:#d9534f;">'.$jum.'</kbd>';?>
                    <span style="float:right;">
                    <input type="text" id="cari" style="width:230px;height:30px;font-size:15px;" placeholder=" cari disini...">
                    ...
                    <form class="form-inline" role="form">
                     ...
                     <th colspan="3"><a>Aksi</a></th>
                      ...
                      <tbody id="fbody">
                      <?php
                      $query=mysqli_query($connect, "SELECT * FROM t_anggota where status='keluar'");
                      $no=1;
                      while($data=mysqli_fetch_array($query)){
            ?>
              <tr>
