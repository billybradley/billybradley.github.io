...
?>
        ...
        <div class="form-panel">
          ...
          <form class="form-inline" role="form">
            <table class="table table-bordered table-striped table-condensed">
              ...
              <tbody><?php
                      $query = mysqli_query($connect, "SELECT * FROM t_petugas 
                  ...
                  <tr>
                    ...
                    <?php $cinta = mysqli_fetch_array(mysqli_query($connect, "SELECT * from t_user where kode_petugas='$lagi' "));
                    ?>
        ...
        <div class="form-panel" style="width:50%;">
          ...
          <form action="petugas/proses_petugas.php?pros=tambah" method="post">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="kode_petugas" size="54" value="<?php echo nomer("P", "kode_petugas", "t_petugas"); ?>" readonly />
            </div>
            <div class="form-group">
              <input type="hidden" class="form-control" name="kode_user" size="54" value="<?php echo nomer("U", "kode_user", "t_user"); ?>" readonly />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" readonly class="form-control" name="u_entry" size="54" value="<?php session_start();
  ...
  $qubah = mysqli_query($connect, "SELECT * FROM t_petugas WHERE kode_petugas='$kode'");
      ...
      <div class="col-lg-12">
        <div class="form-panel" style="width:50%;">
          ...
          <form action="petugas/proses_petugas.php?pros=ubah" method="post">
            ...
            <div class="form-group">
              <label>Jenis Kelamin</label>
              <input type='radio' name='jenis_kelamin' value='Laki-laki' <?php if ($data2['jenis_kelamin'] == "Laki-laki") {
                                                                            echo 'checked';
                                                                          } ?>> Laki-laki
              <input type='radio' name='jenis_kelamin' value='Perempuan' <?php if ($data2['jenis_kelamin'] == "Perempuan") {
                                                                            echo 'checked';
                                                                          } ?>> Perempuan
            </div>
            <div class="form-group">
