...
$a=mysqli_query($connect, "SELECT * from t_anggota ");
$b=mysqli_num_rows($a);
$c=mysqli_fetch_array(mysqli_query($connect, "SELECT SUM(besar_pinjam) as total_pinjam from t_pinjam"));
$d=mysqli_fetch_array(mysqli_query($connect, "SELECT SUM(besar_angsuran) as total_angsuran from t_angsur"));
$e=mysqli_fetch_array(mysqli_query($connect, "SELECT SUM(besar_tabungan) as total_tabungan from t_tabungan"));
$f=mysqli_fetch_array(mysqli_query($connect, "SELECT SUM(denda) as denda from t_angsur"));
...
<div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box">
            <div class="panel" style="border: 2px solid#5cb85c; ">
              <div class="panel-heading"  style="background-color:#5cb85c; color:#fff;"><h3>Tabungan<i class="fa fa-save" style="float:right;"></i></h3></div>
              <div class="panel-body">
               <span style="font-size:20px;">Rp. <?php echo number_format($e['total_tabungan']); ?></span>
              </div>
            </div>
