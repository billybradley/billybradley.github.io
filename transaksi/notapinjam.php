...
$sqla=mysqli_fetch_array(mysqli_query($connect, "SELECT * from t_anggota where kode_anggota='$kode_anggota'"));
$sqlb=mysqli_fetch_array(mysqli_query($connect, "SELECT * from t_jenis_pinjam where kode_jenis_pinjam='$kode_jenis'"));
?>
