...
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'  Alamat : Jl Bla Bla Bla',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'  url ato apalah',0,'L');
...
$sql=mysqli_query($connect, "SELECT * from t_pinjam where month(tgl_entri)='$bulan' and year(tgl_entri)='$tahun'");
    $nomer=1;
...
$jum=mysqli_num_rows(mysqli_query($connect,"SELECT*from t_angsur where kode_pinjam='$kd_p' and kode_anggota='$kd_a'"));$lama=mysqli_fetch_array(mysqli_query($connect, "SELECT lama_angsuran from t_pinjam where kode_pinjam='$kd_p' and kode_anggota='$kd_a'"));
...
$pdf->SetFont('Arial','',10);
	$query = mysqli_query($connect, "SELECT * from t_simpan where month(tgl_entri)='$bulan' and year(tgl_entri)='$tahun'");
	$no=1;	
...
$pdf->SetFont('Arial','',10);
$no=1;
$q=mysqli_query($connect,"SELECT*from t_angsur where month(tgl_entri)='$bulan' and year(tgl_entri)='$tahun'");
