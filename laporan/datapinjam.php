...
<div class="row">
  <div class="col-lg-12">
     <div class="form-panel">
        ...
        <?php
                        $am=mysqli_query($connect,"select*from t_pinjam");
...
<form class="form-inline" role="form">
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
    <?php $sql=mysqli_query($connect,"SELECT * from t_pinjam order by kode_pinjam desc");
    $nomer=1;
    while($data=mysqli_fetch_array($sql))
    	{
    		$kd_a=$data['kode_anggota'];
    		$anggota=mysqli_fetch_array(mysqli_query($connect,"SELECT nama_anggota from t_anggota where kode_anggota='$kd_a'"));
			...
			<td>';$jum=mysqli_num_rows(mysqli_query($connect,"SELECT*from t_angsur where kode_pinjam='$kd_p' and kode_anggota='$kd_a'"));$lama=mysqli_fetch_array(mysqli_query($connect,"SELECT lama_angsuran from t_pinjam where kode_pinjam='$kd_p' and kode_anggota='$kd_a'"));
...
<?php 
	...
	$q=mysqli_query($connect,"SELECT*from t_angsur where kode_pinjam='$kode_pinjam' AND kode_anggota='$kode' order by kode_angsur desc");
	
?>
<div class="row">
  <div class="col-lg-12">
     <div class="form-panel">
        <h4 class="mb"><span class='glyphicon glyphicon-briefcase'></span> Laporan Angsuran "<?php $angg=mysqli_fetch_array(mysqli_query($connect,"SELECT nama_anggota from t_anggota where kode_anggota='$kode'")); echo $angg['nama_anggota'];?>" 
...
<form class="form-inline" role="form">
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
    <?php $sql=mysqli_query($connect,"SELECT * from t_pinjam where status='belum lunas' order by kode_pinjam desc");
    $nomer=1;
    while($data=mysqli_fetch_array($sql))
    	{
...
<form class="form-inline" role="form">
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
    <?php $sql=mysqli_query($connect,"SELECT * from t_pinjam where status='belum lunas'");
    $nomer=1;
    while($data=mysqli_fetch_array($sql))
    	{
    		$a=$data['tgl_tempo'];$dat=date("Y-m-d");
