...
$sql=mysqli_query("SELECT * from t_pinjam where status='belum lunas'");
$nomer=1;
while($data=mysqli_fetch_array($sql))
{
    ...
    $anggota=mysqli_fetch_array(mysqli_query("SELECT nama_anggota from t_anggota where kode_anggota='$kd_a'"));
    $kd_j=$data['kode_jenis_pinjam'];
    $jenis=mysqli_fetch_array(mysqli_query("SELECT nama_pinjaman from t_jenis_pinjam where kode_jenis_pinjam='$kd_j'"));
