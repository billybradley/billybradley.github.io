...
$kode=$_GET['kode'];
$nama=mysqli_fetch_array(mysqli_query($connect, "SELECT nama_anggota from t_anggota where kode_anggota='$kode'"));
...
$hasil=mysqli_fetch_array(mysqli_query($connect,"SELECT sum(besar_simpanan) as besar from t_simpan where kode_anggota='$kode'"));
