...
<div class="row mt">
  <div class="col-lg-12">
     <div class="form-panel">
        ...
        <?php
         $am=mysqli_query($connect, "select*from t_jenis_simpan");
...
<?php
$no=1;
$sql=mysqli_query($connect, "SELECT * FROM t_jenis_simpan");
...
<div class="form-group">
 ...
 <input type="text" class="form-control" name="kode_jenis_simpan" size="54" value="<?php echo nomer("S","kode_jenis_simpan","t_jenis_simpan");?>" readonly/>
</div>
<div class="form-group">
...
<?php
		...
		$qubah=mysqli_query($connect, "SELECT * FROM t_jenis_simpan WHERE kode_jenis_simpan='$kode'");
