...
?>
        ...
        <div class="form-panel">
          ...
          <form class="form-inline" role="form">
            <table class="table table-bordered table-striped table-condensed">
              ...
              <tbody>
                <?php
                $sqlku = mysqli_query($connect, "SELECT * from t_user");
                $no = 1;
        ...
        <div class="form-panel" style="width:50%;">
          ...
          <form action="setting/proses_user.php?pros=tambah" method="post" id="form">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="kode_user" size="54" value="<?php echo nomer("U", "kode_user", "t_user"); ?>" readonly title="Kode harus diisi" />
  ...
  $kode = $_GET['kode_user'];
  $q = mysqli_query($connect, "SELECT * FROM t_user WHERE kode_user='$kode'");
