...
<?php
$no=1;
$sql=mysqli_query($connect, "SELECT * FROM t_jenis_pinjam");
...
<div class="form-group">
 ...
 <input type="text" class="form-control" name="kode_jenis_pinjam" size="54" value="<?php echo nomer("P","kode_jenis_pinjam","t_jenis_pinjam");?>" readonly/>
</div>
<div class="form-group">
...
<?php
		...
		$q=mysqli_query($connect, "SELECT * FROM t_jenis_pinjam WHERE kode_jenis_pinjam='$kode'");
