...
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'  Alamat : Jln. Blablablabla',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'  http://www.facebook.com',0,'L');
...
$rino=mysqli_fetch_array(mysqli_query($connect, "SELECT *from t_pengajuan where kode_pengajuan='$kode_peng' "));
$veno=$rino['kode_anggota'];
$verida=mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM t_anggota where kode_anggota='$veno' "));
